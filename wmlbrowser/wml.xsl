  ...
  <xsl:template match="wml">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <script id='_wml_head_js' type="text/javascript" src="">// hack</script>
        <link id='_wml_head_css' href="" rel="stylesheet" type="text/css" />
      </head>
    ...
    <select onchange="nsWMLcheckSelect(this);">
      ...
      <xsl:for-each select=".//option">
        ...
        <option>
          ...
          <xsl:if test="@onpick">
            <xsl:attribute name="value"><xsl:value-of select="@onpick" /></xsl:attribute>
            <xsl:attribute name="class">_wml_onPick</xsl:attribute>
<!--           <xsl:if test="@onpick">
